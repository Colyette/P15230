 ...
 * uses set mutex pointer for mutual exclusion of the i2c file handler
...
class Adafruit_L3GD20
{
  public:
    ...
    Adafruit_L3GD20(void);   //this is the i2c driver use instantiation

    bool begin(l3gd20Range_t rng=L3DS20_RANGE_250DPS, uint8_t addr=L3GD20_ADDRESS);
    void read(void);
  ...
  private:
    ...
    bool readBytes(uint8_t address, uint8_t reg, uint8_t* buffer, uint8_t nBytes);
